...
def main_func (entries):
    ...
    #webbrowser.open('file://' + os.path.join(BASE_DIR, 'PlumeMap.html'))
    webbrowser.open('file://' + os.path.join(BASE_DIR, 'PlumeMap.html'))
...
FIELD_NAMES = ['Choose Nuclear Power Plant:','Atmospheric Stability (A-G):','Wind Direction:','Downwind Distance (m):'
